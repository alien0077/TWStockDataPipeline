...
if args.domain == "market":
    output = collectors.sync_market(args.date, args.data_root)
elif args.domain == "institutional":
    output = collectors.sync_institutional(args.date, args.data_root)
elif args.domain == "margin":
    output = collectors.sync_margin(args.date, args.data_root)
